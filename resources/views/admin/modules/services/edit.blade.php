...
@section('content')
    <div class="page-wrapper">
        ...
        <!-- Page body -->
        <div class="page-body">
          <form action="{{ route('admin.services.update', $service_tr->id) }}" method="post">
            @method('put')
            @csrf
            <div class="container-xl">
                    ...
                    <div class="card-body">
                      <div class="mb-3">
                        <label class="form-check form-switch">
                          <input class="form-check-input" type="checkbox" name="status" value="1" @checked($service_tr->status === 1)>
                      ...
                      <div class="tab-content">
                        ...
                        <div class="tab-pane active show" id="form-turkish-tab" role="tabpanel">
                          <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="title_tr" name="title_tr" placeholder="{{ __('admin.title') }} ({{ __('main.turkish') }})..." value="{{ $service_tr->title }}" required>
                          </div>
                          <div class="mb-3">
                            <label class="form-label" for="content_tr">{{ __('admin.content') }} ({{ __('main.turkish') }})</label>
                            <textarea class="form-control" id="content_tr" name="content_tr" rows="6" placeholder="{{ __('admin.content') }} ({{ __('main.turkish') }})..." required>{{ $service_tr->content }}</textarea>
                          </div>
                        </div>
                        ...
                        <div class="tab-pane" id="form-english-tab" role="tabpanel">
                          <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="title_en" name="title_en" placeholder="{{ __('admin.title') }} ({{ __('main.english') }})..." value="{{ $service_en->title }}" required>
                          </div>
                          <div class="mb-3">
                            <label class="form-label" for="content_en">{{ __('admin.content') }} ({{ __('main.english') }})</label>
                            <textarea class="form-control" id="content_en" name="content_en" rows="6" placeholder="{{ __('admin.content') }} ({{ __('main.english') }})..." required>{{ $service_en->content }}</textarea>
                          </div>
                        </div>
                        ...
                        <div class="tab-pane" id="form-german-tab" role="tabpanel">
                          <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="title_de" name="title_de" placeholder="{{ __('admin.title') }} ({{ __('main.german') }})..." value="{{ $service_de->title }}" required>
                          </div>
                          <div class="mb-3">
                            <label class="form-label" for="content_de">{{ __('admin.content') }} ({{ __('main.german') }})</label>
                            <textarea class="form-control" id="content_de" name="content_de" rows="6" placeholder="{{ __('admin.content') }} ({{ __('main.german') }})..." required>{{ $service_de->content }}</textarea>
                          </div>
                        </div>
