                                ...
                                <div class="card-body">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select class="form-select" name="category" id="category">
                                            <option value="project" @selected(old('category')==='project')>{{ __('admin.project') }}</option>
                                            <option value="web-template" @selected(old('category')==='web-template')>{{ __('admin.web_template') }}</option>
                                            <option value="ui" @selected(old('category')==='ui')>{{ __('admin.ui_element') }}</option>
                                        </select>
                                    </div>

                                    <!-- Select: stage -->
                                    <div class="mb-3">
                                        <label class="form-label" for="stage">{{ __('admin.stage') }}</label>
                                        <select class="form-select" name="stage" id="stage">
                                            <option value="inprogress" @selected(old('stage')==='inprogress')>{{ __('admin.in_progress') }}</option>
                                            <option value="completed" @selected(old('stage')==='completed')>{{ __('admin.completed') }}</option>
                                            <option value="canceled" @selected(old('stage')==='canceled')>{{ __('admin.canceled') }}</option>
                                        </select>
                                    </div>
                                        ...
                                        <div class="tab-pane active show" id="form-turkish-tab" role="tabpanel">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <textarea class="form-control" id="content_tr" name="content_tr" rows="6"
                                                    placeholder="{{ __('admin.content') }} ({{ __('main.turkish') }})..." required>{{ old('content_tr') }}</textarea>
                                            </div>
                                        ...
                                        <div class="tab-pane" id="form-english-tab" role="tabpanel">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <textarea class="form-control" id="content_en" name="content_en" rows="6"
                                                    placeholder="{{ __('admin.content') }} ({{ __('main.english') }})..." required>{{ old('content_en') }}</textarea>
                                            </div>
                                        ...
                                        <div class="tab-pane" id="form-german-tab" role="tabpanel">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <textarea class="form-control" id="content_de" name="content_de" rows="6"
                                                    placeholder="{{ __('admin.content') }} ({{ __('main.german') }})..." required>{{ old('content_de') }}</textarea>
                                            </div>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <button type="submit" class="btn btn-primary"><svg
                                        ...
                                        </svg>{{ __('admin.create_portfolio') }}</button>
                                </div>
                            </div>
                        </div>
                    </div>
