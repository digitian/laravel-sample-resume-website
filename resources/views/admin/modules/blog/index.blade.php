...
@section('title', __('admin.blog') . ' - ' . __('admin.overview'))
            ...
            <div class="row g-2 align-items-center">
              ...
              <div class="col-auto ms-auto d-print-none">
                <div class="btn-list">
                  ...
                  <a href="{{ route('admin.blog.create') }}" class="btn btn-primary d-sm-none btn-icon" aria-label="{{ __('admin.add_post') }}">
                    <svg xmlns="http://www.w3.org/2000/svg" class="icon" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M12 5l0 14" /><path d="M5 12l14 0" /></svg>
                  </a>
                </div>
              </div>
                        ...
                        <tr>
                            <td>
                                <div class="d-flex align-items-center">
                                  <span class="avatar avatar-sm" style="background-image: url({{ $blog->image ? Storage::url($blog->image) : '' }})"></span>
                                  <div class="font-weight-medium ms-2">{{ $blog->title }}</div>
                                </div>
                            </td>
