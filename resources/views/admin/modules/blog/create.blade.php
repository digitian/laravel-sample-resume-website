...
@section('title', __('admin.add_post'))
                      ...
                      <div class="tab-content">
                        ...
                        <div class="tab-pane active show" id="form-turkish-tab" role="tabpanel">
                          ...
                          <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="description_tr" name="description_tr" placeholder="{{ __('admin.description') }} ({{ __('main.turkish') }})..." value="{{ old('description_tr') }}" required>
                          </div>

                          <!-- Input: content -->
                          <div class="mb-3">
                            <label class="form-label" for="content_tr">{{ __('admin.content') }} ({{ __('main.turkish') }})</label>
                            <textarea id="content_tr" name="content_tr">{!! old('content_tr') !!}</textarea>
                          </div>

                          <!-- Input: keywords -->
                          <div class="mb-3">
                            <label class="form-label" for="keywords_tr">{{ __('admin.keywords') }} ({{ __('main.turkish') }})</label>
                            <input type="text" class="form-control" id="keywords_tr" name="keywords_tr" placeholder="{{ __('admin.keywords') }} ({{ __('main.turkish') }})..." value="{{ old('keywords_tr') }}">
                          </div>

                          <!-- Input: category -->
                          <div class="mb-3">
                            <label class="form-label" for="category_tr">{{ __('admin.category') }} ({{ __('main.turkish') }})</label>
                            <input type="text" class="form-control" id="category_tr" name="category_tr" placeholder="{{ __('admin.category') }} ({{ __('main.turkish') }})..." value="{{ old('category_tr') }}">
                          </div>
                        ...
                        <div class="tab-pane" id="form-english-tab" role="tabpanel">
                          ...
                          <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="description_en" name="description_en" placeholder="{{ __('admin.description') }} ({{ __('main.english') }})..." value="{{ old('description_en') }}" required>
                          </div>
                          ...
                          <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="keywords_en" name="keywords_en" placeholder="{{ __('admin.keywords') }} ({{ __('main.turkish') }})..." value="{{ old('keywords_en') }}">
                          </div>

                          <!-- Input: category -->
                          <div class="mb-3">
                            <label class="form-label" for="category_en">{{ __('admin.category') }} ({{ __('main.turkish') }})</label>
                            <input type="text" class="form-control" id="category_en" name="category_en" placeholder="{{ __('admin.category') }} ({{ __('main.turkish') }})..." value="{{ old('category_en') }}">
                          </div>
                        ...
                        <div class="tab-pane" id="form-german-tab" role="tabpanel">
                          ...
                          <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="description_de" name="description_de" placeholder="{{ __('admin.description') }} ({{ __('main.german') }})..." value="{{ old('description_de') }}" required>
                          </div>
                          ...
                          <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="keywords_de" name="keywords_de" placeholder="{{ __('admin.keywords') }} ({{ __('main.turkish') }})..." value="{{ old('keywords_de') }}">
                          </div>

                          <!-- Input: category -->
                          <div class="mb-3">
                            <label class="form-label" for="category_de">{{ __('admin.category') }} ({{ __('main.turkish') }})</label>
                            <input type="text" class="form-control" id="category_de" name="category_de" placeholder="{{ __('admin.category') }} ({{ __('main.turkish') }})..." value="{{ old('category_de') }}">
                          </div>
    ...
    <script>
      ...
      document.addEventListener("DOMContentLoaded", function () {
        let options_tr = {
          ...
          toolbar: 'undo redo | accordion accordionremove | importword exportword exportpdf | math | blocks | bold italic underline strikethrough | align numlist bullist | link image | table media | lineheight outdent indent| forecolor backcolor removeformat | charmap emoticons | code fullscreen preview | save print | pagebreak anchor codesample | ltr rtl',
