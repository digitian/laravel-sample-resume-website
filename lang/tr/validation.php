...
return [
    ...
    | varsayılan hata mesajlarını içerir. Bu kuralların bazıları, boyut
    | kuralları gibi, birden fazla versiyona sahiptir. Buradaki mesajları
    ...
    */
    ...
    'after_or_equal' => ':attribute alanı :date tarihinden sonraki ya da ona eşit bir tarih olmalıdır.',
    ...
    'before_or_equal' => ':attribute alanı :date tarihinden önceki ya da ona eşit bir tarih olmalıdır.',
    'between' => [
    ...
    'gte' => [
        ...
        'file' => ':attribute alanı :value kilobayttan büyük ya da eşit olmalıdır.',
        'numeric' => ':attribute alanı :value değerinden büyük ya da eşit olmalıdır.',
        'string' => ':attribute alanı :value karakterden uzun ya da eşit olmalıdır.',
    ],
    ...
    'lte' => [
        ...
        'file' => ':attribute alanı :value kilobayttan küçük ya da eşit olmalıdır.',
        'numeric' => ':attribute alanı :value değerinden küçük ya da eşit olmalıdır.',
        'string' => ':attribute alanı :value karakterden kısa ya da eşit olmalıdır.',
    ],
    ...
    'required_array_keys' => ':attribute alanı şu anahtarlar için girişler içermelidir: :values.',
    ...
    |--------------------------------------------------------------------------
    |
    | Burada belirli özellikler için özel doğrulama mesajları tanımlayabilirsiniz.
    | "attribute.rule" kural adlandırma yöntemi kullanılır.
    |
    */
    ...
    /*
    |--------------------------------------------------------------------------
    | Özelleştirilmiş Doğrulama Özellikleri
    |--------------------------------------------------------------------------
    |
    | Aşağıdaki dil satırları "email" yerine "E-Posta Adresi" gibi daha
    | kullanıcı dostu bir şeyle attribute yer tutucusunu değiştirmek için
    | kullanılabilir. Bu, mesajlarımızı daha açıklayıcı hale getirmemize yardımcı olur.
    |
    */
